        ...
        <div style={{ background: "white", borderRadius: "24px", padding: "2.25rem", boxShadow: "0 20px 60px rgba(0,0,0,0.09)", border: "1px solid var(--color-border)" }}>
          ...
          <form onSubmit={handleSubmit} style={{ display: "flex", flexDirection: "column", gap: "1rem" }}>
            ...
            <button type="submit" disabled={loading}
              style={{ marginTop: "0.25rem", padding: "0.82rem", borderRadius: "12px", border: "none", background: loading ? "#d4b896" : "linear-gradient(135deg,#c8a96e,#a8854a)", color: "white", fontWeight: 700, fontSize: "0.95rem", cursor: loading ? "not-allowed" : "pointer", boxShadow: "0 4px 14px rgba(200,169,110,0.35)", fontFamily: "inherit" }}>
