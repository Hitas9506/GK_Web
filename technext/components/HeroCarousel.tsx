...
const SLIDES: Slide[] = [
  /* 1 ── Xiaomi 17 Ultra */
  {
    ...
    cta:  { label: "Tìm hiểu thêm", href: "/products/1" },
    cta2: { label: "Mua ngay →",    href: "/products/1" },
  ...
  /* 2 ── Samsung S25/S26 Ultra */
  {
    ...
    cta:  { label: "Tìm hiểu thêm", href: "/products/4" },
    cta2: { label: "Mua ngay →",    href: "/products/4" },
     ...
     Video dọc/portrait → dùng "contain" + fullDarkOverlay để nền hoàn toàn đen */
  {
    ...
    cta:  { label: "Tìm hiểu thêm", href: "/products/5" },
    cta2: { label: "Mua ngay →",    href: "/products/5" },
     ...
     Video cũng dạng landscape không khớp tỷ lệ → dùng "contain" */
  {
    ...
    cta:  { label: "Tìm hiểu thêm", href: "/products/12" },
  ...
  /* 5 ── Xiaomi Pad 8 Pro */
  {
    ...
    cta:  { label: "Tìm hiểu thêm", href: "/products/11" },
    cta2: { label: "Mua ngay →",    href: "/products/11" },
