...
export default function ProfilePage() {
  ...
  return (
    <div style={{ paddingTop: "92px", minHeight: "100vh", background: "linear-gradient(135deg,#F5F5F5,#E8E8E8)" }}>
      {/* Hero */}
          ...
          {tab === "info" && (
            <form onSubmit={handleSaveInfo}>
              ...
              <div style={{ display: "flex", alignItems: "center", gap: "1rem", marginTop: "1.5rem" }}>
                <button type="submit" style={{ padding: "0.72rem 1.75rem", borderRadius: "10px", border: "none", background: "var(--color-accent)", color: "white", fontWeight: 700, cursor: "pointer", fontFamily: "inherit" }}>
                  Lưu thay đổi
                </button>
